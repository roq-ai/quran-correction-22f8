...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'CourseCreated.create': {
    roles: ['administrator', 'teacher', 'technical-support'],
    key: 'courseId',
    tenantPath: [],
    userPath: [],
  },
  'TicketOpened.create': {
    roles: ['administrator', 'technical-support'],
    key: 'ticketId',
    tenantPath: [],
    userPath: [],
  },
  'PaymentReceived.create': { roles: ['administrator'], key: 'paymentId', tenantPath: [], userPath: [] },
};
