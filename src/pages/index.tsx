...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Quran Correction`}</title>

        <meta
          name="description"
          content="Quran Correction: Empowering Your Online Quran Reading Journey. Correcting Misreads, Enhancing Understanding. Read, Learn, and Grow with Us."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1609599006353-e629aaabfeae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxRdXJhbnxlbnwwfHx8fDE2OTU0Njk3NzN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@malikshibly?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Malik Shibly`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Quran Correction: Empowering Your Online Quran Reading Journey. Correcting Misreads, Enhancing Understanding. Read, Learn, and Grow with Us.`}
            </Text>
            <Box
